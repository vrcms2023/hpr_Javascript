...
const NewsAndUpdates = () => {
  ...
  const [news, setNews] = useState([
    ...
    },
    {
      ...
      description:
        "HPR has ventured in the real estate world with a humble beginning in the year 2004, with Director D. Hari Srinivas who has vision and has successfully completed several projects in Hyderabad. Riding on the growth wave of real-estate, the group has diversified strategically into the development of land.",
    },
    {
      id: 3,
      img: "NewsImg3",
      ...
      description:
        "Abibaltla had become prominent because of IT SEZ & Aero Space SEZ. TCS, CTS, and small other companies had been allotted land in IT SEZ. TCS, which is about to complete the construction is expected to generate an employment of 27,000 employees in Adibatla Campus.",
    },
    {
      id: 4,
      img: "NewsImg1",
      ...
      description:
        "Tata Advanced Systems, a group company of Tata’s started their manufacturing facility for Helicopter units, wings manufacturing in collaboration with LOCKHEED MARTIN and SIKORSKY AIRCRAFT CORPORATION in the Aerospace SEZ, Adibatla.",
    },
    {
      id: 5,
      img: "NewsImg2",
      ...
      description:
        "Tata Advanced Systems, a group company of Tata’s started their manufacturing facility for Helicopter units",
    },
    {
      id: 6,
      img: "NewsImg3",
    ...
    },
    {
      ...
      description:
        "Hardware Park, near Thukkuguda is already holding so many companies creating an employment of 3000. The ITIR project announced by the Central Govt. is expected to further fuel the growth in this area. News related to this project can be viewed in the links provided below.",
    },
    {
      id: 8,
      img: "NewsImg2",
      ...
      description:
        "The ITIR project announced by the Central Govt. is expected to further fuel the growth in this area. ",
    },
    {
      id: 9,
      img: "NewsImg3",
      ...
      description:
        "News related to this project can be viewed in the links provided below. The ITIR project announced by the Central Govt. is expected to further fuel the growth in this area. News related to this project can be viewed in the links provided below.",
    },
  ]);
          ...
          {news.length > 0 &&
            news.map((item) => (
              ...
              >
                ...
                <Title
                  title={item.title}
                  cssClass="text-dark fs-6 mt-3 fw-bold"
                />
                <p className="card-text mb-4">{item.description}</p>
                <Link
                  to=""
                  onClick={() => articleHandler(item.id)}
                  className="loadMore"
                >
                  Read more
                  <svg
