...
const Amenities = () => {
  return (
    <>
        ...
        <Title title="Move into a home that will reflect your lifestyle" cssClass="fw-normal fs-5 text-dark"/>
        <hr />
        <Title title="2BHK/3BHK Gated Community HPR Lakefront@ HAFEEZPET" cssClass="fw-normal fs-2 my-5 text-white text-center text-dark"/>
        <hr />
        <div className='d-flex justify-content-between align-items-center pt-4'>
          <ul className="list-group list-unstyled mx-5 w-50">
              ...
              <li className='mb-3'>Upto 1KVA (ACCL) D.G Backup for each flat and 100% D.G backup for common areas</li>
          ...
          <ul className="list-group list-unstyled mx-5 w-50">
            ...
            <li className='mb-3'>Indoor Games: Billiards, Carrom Table Tennis etc.,</li>
          </ul>  
        </div>        
    </>
  )
