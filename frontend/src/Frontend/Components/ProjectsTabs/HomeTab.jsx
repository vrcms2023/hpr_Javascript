...
const HomeTab = () => {
  return (
    <div className="py-5">
      ...
      <div>
        <p>
          Pragati Plaza by the Pragati Builders situated in Electronic City,
          Bangalore is much more than just an apartment. Being a class in
          itself, this opulent piece of the project is the amalgamation of
          excellent, chic and peaceful homes. It allows you to inhale and exhale
          the air and keep you warm in the natural light. Made up of exclusive
          features and desirable amenities, everyone would experience the
          positivity here with no disturbance. This meticulous and luxury tower
          is wisely made just for your comfort.
        </p>
      </div>
