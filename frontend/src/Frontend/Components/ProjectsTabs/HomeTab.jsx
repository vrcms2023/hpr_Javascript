...
const HomeTab = ({project, projectImages, pdfs}) => {
  ...
  return (
    <div className="py-5">
      ...
      <Title
        title={aboutussubtitle}
        cssClass="fs-6 text-dark"
      />
      <div className="py-3">
          {description}
      </div>
      <p className="text-end">
        ...
        {pdfs.length > 0 ? pdfs.map((pdf, i) => (
          ...
          <a href={pdf.path} className="text-dark me-2" download> {pdf.originalname}</a>
          <svg
            width="18"
            height="23"
            viewBox="0 0 16 20"
      ...
      <div className="text-center my-5">
        <img src={projectImages.length > 0 ? projectImages[0].path : HomeImg}  className="rounded img-fluid w-50" alt="..." />
