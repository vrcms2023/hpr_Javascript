  ...
  return (
    <>
      ...
      <div className='row py-3 introGrayBg'>
        ...
        <p className='text-center lh-md'>HPR Infra Projects has instantly made a distinctive mark on the cityscape of Hyderabad: the city in which the group is headquartered, as it understands the city with an instinctive ease sharing with it a glorious past and a promising future.</p>
        </div>
      </div>
      <div className='container my-5 py-4'>
        <div className='row shadow-lg'>
          <div className="col-12 col-md-8  py-4 p-md-5">
            ...
            <Title title="About HPR Infra" cssClass="text-dark fs-4"/>
              <p>HPR has ventured in the real estate world with a humble beginning in the year 2004, with Director D. Hari Srinivas who has vision and has successfully completed several projects in Hyderabad. Riding on the growth wave of real-estate, the group has diversified strategically into the development of land.</p>
              ...
              <p className=''>Abibaltla had become prominent because of IT SEZ & Aero Space SEZ. TCS, CTS, and small other companies had been allotted land in IT SEZ. TCS, which is about to complete the construction is expected to generate an employment of 27,000 employees in Adibatla Campus.</p>
              ...
              <p>The ITIR project announced by the Central Govt. is expected to further fuel the growth in this area. News related to this project can be viewed in the links provided below.</p>
          </div>
        ...
        <div className='row shadow-lg my-5'>
            <div className="col-12 col-md-4 d-none d-md-block p-0 " >
              ...
              <p>Our vision and intent now encompass to not just build better homes or offices, but to provide a better quality of life for people who are a part of any facility which the Group has created. The focus is to strive to impart better quality through the development of world-class neighborhoods, which will enrich the lives of anyone living or working within these self-contained environs.</p>
              </div>
          </div>
          ...
          <Title title="What makes us a futuristic group?" cssClass="text-dark fs-4"/>
          <p className='lh-lg'>
              <strong>To excel in delivery of work.</strong><br />
              <strong>To adhere to the highest standards of professional ethics.</strong><br />
              <strong> To introduce several ‘firsts’ in the industry.</strong>
             
            </p>
          <p>To maintain transparency with our Investors, Associates, Clients, Service Providers, Employees and contribute to the society at large.</p>
          </div>
          <div className="col-12 col-md-4 d-none d-md-block p-0">
