  ...
  return (
    <>
      ...
      <div className="col-lg-8 p-5">
            ...
            <Title title="To excel in delivery of work!" cssClass="fs-5"/>
            <hr />
            <p>HPR Infra Projects has instantly made a distinctive mark on the cityscape of Hyderabad: the city in which the group is headquartered, as it understands the city with an instinctive ease sharing with it a glorious past and a promising future.</p>
